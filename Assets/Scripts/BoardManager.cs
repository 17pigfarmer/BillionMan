...
public class BoardManager : MonoBehaviour
{
    ...
    void SetPlayers()
    {
        ...
        GameObject pl0to = players[2];
        GameObject pl0 = Instantiate(pl0to, Positions[0] + GetVector3withZequal0(new Vector3(-0.131f, 0.13f, 0)), Quaternion.identity) as GameObject;
        GameManager.instance.players[0] = pl0;

        GameObject pl1to = players[3];
        GameObject pl1 = Instantiate(pl1to, Positions[0] + GetVector3withZequal0(new Vector3(0.131f, -0.13f, 0)), Quaternion.identity) as GameObject;
        GameManager.instance.players[1] = pl1;

        GameObject pl2to = players[0];
        GameObject pl2 = Instantiate(pl2to, Positions[0] + GetVector3withZequal0(new Vector3(-0.13f, -0.13f, 0)), Quaternion.identity) as GameObject;
        GameManager.instance.players[2] = pl2;

        GameObject pl3to = players[1];
        GameObject pl3 = Instantiate(pl3to, Positions[0] + GetVector3withZequal0(new Vector3(0.13f, 0.13f, 0)), Quaternion.identity) as GameObject;
    ...
    Vector3 GetVector3withZequal0(Vector3 old)
    {
        Vector3 newvec = new Vector3(old.x + old.y, (old.y - old.x) * 0.71f, 0);
